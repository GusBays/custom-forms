...
@section('content')
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <button id="confirm-button" class="btn btn-success w-100 border-0" style="background-color:#7800D2" register disabled>Cadastrar-se</button>
                            </div>
                            <div class="col-12 col-md-6">
    ...
    <script type="module" src="{{ env('APP_URL') }}/assets/js/services/organizationService.js"></script>
@endsection