<div class="col-12 mb-5 col-md-6 col-lg">
    <div class="list-group shadow p-3 mb-0 bg-body-tertiary rounded">
        <a class="list-group-item list-group-item-action" href="/formularios/{{ $form->getId() }}">
            <h5>{{ $form->getName() }}</h5>
        ...
        <a href="/formularios/{{ $form->getId() }}/respostas" type="button" class="list-group-item mt-3 list-group-item-action">
